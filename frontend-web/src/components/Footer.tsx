    ...
    <footer id="footer" className="bg-slate-950 text-slate-400 font-['Inter',sans-serif] border-t border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-xs leading-relaxed text-slate-400 max-w-sm">
              Indore’s premier zero-brokerage rental & plot marketplace. Backed by PostGIS spatial geofencing and physical Ground Boy verification to eliminate fake listings and ghost addresses.
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <a href="#why-us" className="hover:text-emerald-400 transition-colors">Why Divyavastu</a>
              </li>
              <li>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5 text-xs">
              ...
              <div className="flex items-center gap-2 text-slate-400">
                ...
                <span>support@divyavastuspaces.com</span>
              </div>
            </div>
      ...
      <div className="border-t border-slate-900 bg-slate-950/90 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>© {new Date().getFullYear()} Divyavastu Spaces Pvt. Ltd. All rights reserved.</p>
          <div className="flex items-center gap-1 text-slate-400">
            <span>Engineered with</span>
            <Heart className="w-3.5 h-3.5 text-emerald-500 fill-emerald-500" />
            <span>for Indore Real Estate Transparency</span>
          </div>
        </div>
      </div>
